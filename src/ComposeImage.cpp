...
ComposeImageFilter::ImageType::Pointer ComposeImageFilter::GetLRImage(ComposeImageFilter::ImageType::Pointer image)
{
	m_imageLR = image;
	std::cout << "Read LR image" << std::endl;
}

ComposeImageFilter::ImageType::Pointer ComposeImageFilter::GetHRImage(ComposeImageFilter::ImageType::Pointer image)
{
	m_imageHR = image;
	std::cout << "Read HR image" << std::endl;
}

void ComposeImageFilter::ReadMatrix(ComposeImageFilter::SparseMatrixType matrix)
{
	m_matrix = matrix;
